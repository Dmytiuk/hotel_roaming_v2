...
(function (root, factory) {
    ...
    Lightpick = function(options)
    {
        ...
        if (opts.footer) {
            html += '<div class="lightpick__footer" style="height: 30px;">';
            if (opts.footer === true) {
                html += '<div class="lightpick__tooltip" style="text-align: center; padding-top: 5px; "  ></div>';
            ...
            if (target.classList.contains('lightpick__day') && target.classList.contains('is-available')) {
                ...
                if (!opts.disabledDatesInRange && opts.disableDates && opts.startDate) {
                    ...
                    if (isInvalidRange.length) {
                        ...
                        self.el.querySelector('.lightpick__tooltip').style.visibility = 'visible';
